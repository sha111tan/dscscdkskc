...
export default function ProfileScreen() {
  ...
  return (
    <div className="justify-center  mt-8 add-product">
      <div className="w-2/3 mx-auto rounded-xl bg-white shadow-md p-6">
        <h2 className="text-center mb-1 text-2xl font-medium">
